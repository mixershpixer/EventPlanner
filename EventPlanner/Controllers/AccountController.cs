...
namespace EventPlanner.Controllers
{
    ...
    public class AccountController : Controller
    {
                        ...
                        case SignInStatus.Success:
                            {
                                ...
                                else return RedirectToAction("ExtraData", "Account");
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ExtraData(AddExtraViewModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { Name = null, Surname = null, UserName = model.Email, Email = model.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Account confirmation EventPlanner", "Confirm your email by this <a href=\"" + callbackUrl + "\">href</a>");
